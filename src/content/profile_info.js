...
export const accent_color = "#ddb945";
...
export const introduction = <div>
  <p>I am a first-year PhD student at <a href="https://www.cs.purdue.edu/">Purdue Computer Science</a>, advised by <a href="https://www.sooyeonjeong.com/home">Sooyeon Jeong</a> in the <a href="https://human-agent-interaction.github.io/HAI-website/">Human-Agent Interaction Lab</a>. My current interests lie in full-stack robotics with a focus on enabling robots to interact with the physical world safely, fluently, and naturally. I aspire to build systems that integrate perception, prediction, planning, and control in the real world. </p>
