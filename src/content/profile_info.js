...
export const introduction = <div>
  <p>I am a third-year PhD student at <a href="https://www.cs.purdue.edu/">Purdue Computer Science</a>, supported by the NSF GRFP and advised by <a href="https://www.sooyeonjeong.com/home">Sooyeon Jeong</a> in the <a href="https://human-agent-interaction.github.io/HAI-website/">Human-Agent Interaction Lab</a>, and <a href="https://joe-campbell.github.io/website/">Joe Campbell</a> in the Collaborative AI for Machines and People Lab. My current interests lie in human-robot interaction and full-stack robotics, focusing on enabling robots to interact with the physical world safely, fluently, and naturally. I aspire to build systems that integrate perception, prediction, planning, and control in the real world. </p>
